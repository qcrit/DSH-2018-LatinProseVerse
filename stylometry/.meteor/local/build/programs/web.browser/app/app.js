...
const generateScatterChart = (element, data) => {
  ...
  module.dynamicImport("chart.js").then((_ref) => {
    let {
      default: Chart
    } = _ref;
    new Chart(mychart, {
...
Template.stylometrygraph.onRendered(function () {
  ...
  function generateBarChart(element, labels, data) {
    ...
    module.dynamicImport("chart.js").then((_ref2) => {
      let {
        default: Chart
      } = _ref2;
      new Chart(mychart, {
...
Template.stylometrytable.onRendered(function () {
  ...
  module.dynamicImport("../hands.js").then((_ref3) => {
    let {
...
},"hands.js":[],"select2.min.js":function(){
